<h2><a href="https://www.geeksforgeeks.org/problems/check-for-subsequence4930/1?utm_source=geeksforgeeks&utm_medium=article_practice_tab&utm_campaign=article_practice_tab">Check for subsequence</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings A and B, find if A is a subsequence of B.</span></p>
